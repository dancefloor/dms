            ...
            <blockquote class="mt-8 md:flex-grow md:flex md:flex-col">
                <div class="relative text-lg leading-7 font-medium text-white md:flex-grow">
                    ...
                    <p class="relative">
                        ...
                        online, because of
                        timezone difference I have to catch up after it goes live, so I appreciate having the videos
                        saved here in the
                        group. I'm looking forward to more classes in the future!
                    </p>
                </div>
                <footer class="mt-8">
                    <div class="flex">
        ...
        <div class="py-12 px-4 sm:px-6 md:flex md:flex-col md:py-10 md:pl-0 md:pr-10 lg:pr-16">
            <blockquote class="mt-8 md:flex-grow md:flex md:flex-col">
                <div class="relative text-lg leading-7 font-medium text-white md:flex-grow">
                    ...
                    <p class="relative">
                        Enjoying every minute! Good pace. Love all the different styles being
                        presented. Thank you so much for letting us join you remotely.
                    </p>
                </div>
                <footer class="mt-8">
                    <div class="flex">
