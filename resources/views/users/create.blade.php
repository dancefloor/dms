...
<div class="container mx-auto -mt-24 px-4 bg-white rounded-lg shadow">
    <form action="{{ route('users.store') }}" method="post" class="py-5 px-8">
        @csrf
        <h1 class="text-2xl font-bold leading-7 text-gray-700 md:text-4xl sm:leading-9 sm:truncate mt-5 mb-10">New User
        </h1>
