<nav class="bg-gray-900 fixed top-0 w-full z-50" x-data="{ openMenu: false}">
    ...
    <div :class="{ 'block': openMenu, 'hidden':!openMenu }" class="hidden sm:hidden">
        <div class="px-2 pt-2 pb-3">
            <a href="{{ route('welcome') }}" class="df-navigation-link">Home</a>
            <a href="{{ route('dashboard') }}" class="df-navigation-link">My Dashboard</a>
            <a href="{{ url('/#live') }}" class="df-navigation-link">Live Classes</a>
            <a href="{{ url('/#online') }}" class="df-navigation-link">Online Classes</a>
            {{-- <a href="#"
