...
<div class="container mx-auto">
    <header class="pt-10 mx-10">
        <h1 class="text-2xl font-bold leading-7 sm:text-3xl sm:leading-9 sm:truncate text-gray-700">Add Role</h1>
    </header>
    <section id="role-form" class="pt-t">
        <form action="{{ route('roles.store') }}" method="post" class="df-form">
            @csrf
            <div class="mb-6">
